...
const ContactDoctorPage = () => {
  const [formData, setFormData] = useState({
    ...
    contactType: 'doctor' // Mark as doctor contact
  });
    ...
    <div className="contact-page">
      <div className="contact-container">
        <div className="contact-info-section">
          ...
          <h1 className="contact-title">Contact Us - Doctor Portal</h1>
          <p className="contact-description">
            For doctors and medical professionals. Whether you have questions about our services, need to collaborate, or want to join our team, we're here to help.
          </p>
